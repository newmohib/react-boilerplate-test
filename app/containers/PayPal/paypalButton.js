            ...
            let detailsInfo={
                ...
                payer:{address: {country_code: "US"},
                 ...
                 purchase_units:[{amount: {value: "1.00", currency_code: "USD"},
                                payee:{email_address:"sb-8ljm1222036@business.example.com", merchant_id: "HGGVB3HQUFP9G"},
                                shipping:{address:{address_line_1: "1 Main St",admin_area_1: "CA",admin_area_2: "San Jose",country_code: "US",postal_code: "95131"},
                                name: {full_name: "Mohibur Rahman"}}}],
                status: "COMPLETED",
                update_time: "2019-09-23T10:24:50Z",
            }
            let dataInfo={orderID: "9J397835BN357942C", payerID: "T9R7ZL82AHJ7Y"};
        }
